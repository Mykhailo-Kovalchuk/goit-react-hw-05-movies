...
const TOKEN_KEY = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxZGRhOTYyOWE3M2ZhZmFiYTM3NTA0OTNlYTQ4NTVmZiIsInN1YiI6IjY1YTUwYjgzOGRiYzMzMDEyMzZhNjg1MSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.4k44fb6f12sXSLjD4YUDgIwseeksxPF-XRmodvwltRY";
...
export function fetchMoviesKeyWord (userQueryWord) {
    ...
    // console.log(URL)
// Example https://api.themoviedb.org/3/search/movie?api_key=YOUR_API_KEY&language=en-US&query=your_search_query&page=1&include_adult=false
